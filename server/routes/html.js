...
module.exports = () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="https://github.com/trade-platform/auth0-logs-to-logdna/assets/auth0-logs-to-logdna.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="https://github.com/trade-platform/auth0-logs-to-logdna/assets/auth0-logs-to-logdna.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="https://github.com/trade-platform/auth0-logs-to-logdna/assets/auth0-logs-to-logdna.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
